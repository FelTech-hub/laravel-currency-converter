                  ...
                  <div class="px-4 py-12 text-white">
                    <div class="flex items-center justify-between mb-5">
                      ...
                      <select 
                          ...
                          focus:text-gray-600  border-4">
                          @foreach ($codes as $code => $value)
                          <option class="py-1" {{ $code == @session('to') || $code == 'NGN' ? 'selected' : ''}}>
                              {{ $code }}
                            </option>
                          @endforeach
                      </select>
                      ...
                      <div class="float-right text-right">
                        <button type="submit" class="bg-blue-600 border font-bold mt-6
                        py-4 px-5 rounded-xl transition-all hover:bg-blue-500">
                          Convert
